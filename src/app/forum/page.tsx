...
export default function ForumPage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* 1. Institutional Header (Light Mode) */}
      ...
      <div className="bg-surface-alt/20 relative">
        ...
        <div className="grid grid-cols-12 gap-16">
          ...
          <div className="col-span-12 xl:col-span-8 space-y-32">
            ...
            {/* Strategic Dispatch & Events Section (Light Mode) */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Strategic Dispatch */}
              <div className="xi-card bg-white border-border group hover:border-primary/50">
                <div className="p-10">
                  ...
                  <h3 className="text-2xl font-display font-bold text-navy-950 uppercase tracking-tight mb-4">Strategic Dispatch</h3>
                  ...
                  <form className="space-y-4">
                    <input 
                      ...
                      className="w-full px-5 py-3.5 bg-surface-alt border border-border text-[11px] font-mono font-bold text-navy-950 uppercase tracking-widest outline-none focus:border-primary transition-all"
                    />
              ...
              <div className="xi-card bg-white border-border group hover:border-primary/50">
                <div className="p-10">
                  ...
                  <h3 className="text-2xl font-display font-bold text-navy-950 uppercase tracking-tight mb-6">Regional Summits</h3>
                  <div className="space-y-6">
                    {[
                      ...
                      <div key={i} className="flex gap-6 border-b border-border pb-6 last:border-0 last:pb-0">
                        ...
                        <span className="text-[10px] font-mono font-bold text-navy-950 uppercase tracking-widest leading-snug">{ev.event}</span>
                      </div>
                    ))}
                  </div>
          ...
          {/* Institutional Intelligence Sidebar (Light Mode) */}
          <div className="col-span-12 xl:col-span-4 space-y-16">
            ...
            <div>
              ...
              <div className="xi-card bg-white border-border shadow-sm">
                <div className="p-10 text-center">
                  <div className="w-24 h-24 border border-border mx-auto mb-8 flex items-center justify-center overflow-hidden bg-surface-alt relative">
                    <div className="absolute inset-0 bg-primary/5" />
                    <Users className="text-navy-950 relative z-10" size={32} />
                  </div>
                  <h3 className="text-2xl font-display font-black text-navy-950 uppercase tracking-tight mb-2">Hamse Aden</h3>
            ...
            {/* Advisory Council */}
            <div className="xi-card bg-white border-l-2 border-l-primary group hover:border-primary transition-all">
              <div className="p-10">
                <div className="flex items-center gap-4 mb-8">
                   ...
                   <h3 className="text-xl font-display font-bold text-navy-950 uppercase tracking-tight">Advisory Council</h3>
                </div>
                ...
                <button className="btn-outline w-full group/btn border-navy-950 text-navy-950 hover:bg-navy-950 hover:text-white">
